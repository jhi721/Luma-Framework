...
// after the gamma pass by the DEV net, blending OFF, so it overwrites the HDR canvas with its constant. See
...
// Luma_ME1_Tonemap.hlsl). This shader reads no interpolator.
void main(
