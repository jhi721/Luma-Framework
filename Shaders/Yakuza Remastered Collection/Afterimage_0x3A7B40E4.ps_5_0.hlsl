// ps_afterimage01 (sh_ogre3_w64.par): afterimage ghost, alpha = 1.6 * texture alpha. Vanilla relied on the UNORM target
// clamping that output alpha to 1 before blending; on the fp16 chain it would extrapolate. Verbatim except the
