...
// clamped per texel before the test (a clamped output would still pass or reject other pixels). Otherwise verbatim.
...
{
   const float3 c = SampleSaturatedBilinear(t0, s0_s, v0.xy).rgb;
