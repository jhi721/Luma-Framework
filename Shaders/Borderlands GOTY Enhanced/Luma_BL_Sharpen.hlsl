...
// Runs after the SMAA neighborhood-blend pass, on the gamma canvas, before the result is copied back into the
// swapchain. paperWhite=1.0; RCAS_LIMIT bounds the lobe so HDR highlights don't over-sharpen.
