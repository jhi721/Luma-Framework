// RCAS on the SMAA output (ME1 2007 / BL2 / TW2 shape): after SMAA's neighborhood blend, on the gamma canvas, written
// back before the HUD and the composition. paperWhite 1.0; RCAS_LIMIT bounds the lobe (values above 1.0 are HDR here).
