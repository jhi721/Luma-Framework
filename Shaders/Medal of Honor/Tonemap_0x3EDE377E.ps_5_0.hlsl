// Medal of Honor (2010) — tonemap + 3D LUT, permutation with EdgeAA and motion blur/DoF both OFF.
// Grade tail in cb4[12]. See Luma_MOH_Tonemap.hlsl for the implementation and the permutation table.
