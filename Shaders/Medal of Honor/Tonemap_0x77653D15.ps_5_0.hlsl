// Medal of Honor (2010) — tonemap + 3D LUT, permutation with motion blur/DoF ON and EdgeAA off.
// Depth linearisation in cb4[10], MB offsets in cb4[12], jitter frequency in cb4[13], grade tail in cb4[14].
// See Luma_MOH_Tonemap.hlsl.
