// Saints Row IV - HDR-weighted MSAA resolve, drawn instead of the game's single ResolveSubresource of the FP16 scene
// (the same grab_scene_color path as Saints Row: The Third; sr_hv.exe calls it at 0x140e46d6c).
//
