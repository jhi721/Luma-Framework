...
// paper white before DICE (0.35 gave 1.36x and 8.9x). The vignette and grain after the shoulder scale the vanilla
// output this multiplies, so they carry into the highlights.
