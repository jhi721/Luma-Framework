...
// so without this a cutscene sits flat at paper white. Body from the 0xE41621CF disasm; register map in NOTES.md.
...
// TONEMAP_TYPE, not display mode - the SDR self-noop does not cover T0 on scRGB, where it reaches 2.06x (NOTES.md).
