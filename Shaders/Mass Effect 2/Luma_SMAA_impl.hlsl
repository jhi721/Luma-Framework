// SMAA for Mass Effect 2 (2010), port of the ME1 2007 / BL2 / TW2 setup. ULTRA + colour edge detection, injected
// post-material on the graded GAMMA canvas over both material perms. Site, grain caveat and evidence: NOTES.md.
...
// load-bearing: flat threshold 0.10 rejects texture noise, silhouettes relax to the 0.05 ULTRA base. See NOTES.md.
