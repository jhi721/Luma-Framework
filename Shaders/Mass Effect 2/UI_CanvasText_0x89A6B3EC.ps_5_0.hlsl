...
// The most frequent HUD draw in the measured frames. See Includes/CanvasUI.hlsl - vanilla body plus the 8-bit clamp.
...
// Luma_ME2_Tonemap.hlsl). This shader reads COLOR0 (v2) and TEXCOORD0 (v5.xy).
void main(
