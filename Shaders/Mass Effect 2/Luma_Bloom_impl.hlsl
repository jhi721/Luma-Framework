...
// LINEAR, pre-glow. Threshold 1.0 = the game's own bright-pass, knee = half. Same threshold as the ME1 2007 port.
...
// b13 (LumaSettings) is re-bound by main.cpp before DrawBloom, which owns b11 for its own constants.
...
// only the excess measured 6x too dim at 1.2. Knee on the WEIGHT and one-sided, from the threshold up.
