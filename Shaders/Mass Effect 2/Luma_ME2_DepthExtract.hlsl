// SMAA predication signal, from the ME1 2007 port. Source is the linear depth UE3 packs in the fp16 scene ALPHA,
// captured at the uber draw. Deviation from the local tangent plane, so the threshold is 0.5 at any scale (NOTES.md).
